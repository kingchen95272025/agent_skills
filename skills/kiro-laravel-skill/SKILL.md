---
name: kiro-laravel-skill
description: Laravel后端系统化开发工作流。当用户需要开发Laravel后端功能、将功能想法转变为代码实现、进行需求梳理、架构设计、任务规划、代码实现、代码复核或代码优化时使用。适用于需要系统化、标准化、高质量的Laravel后端开发场景。
---

# Kiro Laravel Backend 工作流
...
- 必须严格遵循 Kiro 六个阶段的工作流，必须从`需求明确阶段`开始，不能跳过任何阶段
...
- **第一阶段**：[需求明确](./phases/01-requirements.md) - 详细说明如何收集和明确需求，严格遵守需求文档标准和示例
- **第二阶段**：[架构设计](./phases/02-design.md) - 详细说明如何进行技术设计，严格遵守技术设计文档标准和示例
- **第三阶段**：[任务规划](./phases/03-tasks.md) - 详细说明如何拆解任务，严格遵守任务规划文档标准和示例
- **第四阶段**：[代码实现](./phases/04-implementation.md) - 详细说明如何实现代码，严格遵守代码实现文档标准和示例
- **第五阶段**：[代码复核](./phases/05-review.md) - 详细说明如何复核代码质量，严格遵守代码复核文档标准和示例
- **第六阶段**：[代码优化](./phases/06-optimization.md) - 详细说明如何优化代码，严格遵守代码优化文档标准和示例

## 参考文档

在工作流的不同阶段，会参考以下标准文档：

- **[技术设计文档标准](./reference/DESIGN_STANDARDS.md)** - 架构设计阶段的标准格式（9个部分）
- **[代码设计示例](./reference/CODE_EXAMPLES.md)** - 各层次代码的详细设计示例
- **[代码复核标准](./reference/REVIEW_CRITERIA.md)** - 代码复核的评分标准和机制
