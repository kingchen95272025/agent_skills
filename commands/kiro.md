...
3. 创建 `.claude/specs/{功能名}/requirements.md` 文档
4. 基于您的描述生成初始需求，**不会先问一系列连续问题**
5. 使用EARS格式（Easy Approach to Requirements Syntax）编写验收标准
6. 采用用户故事和验收标准格式：
...
10. 自然地询问："任务规划看起来合理吗？如果同意的话，我们可以开始逐个实现了"
